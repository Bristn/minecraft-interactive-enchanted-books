...
public class ModGameRules {
    public static final GameRule<Boolean> HOPPER_INTERACTS_WITH_LECTERN = registerBoolean(true, "hopper_interacts_with_lectern");
    public static final GameRule<Boolean> SIGNAL_CHANGES_LECTERN_PAGE = registerBoolean(true, "signal_changes_lectern_page");
    public static final GameRule<Boolean> CRAFTABLE_ENCHANTMENT_ECHO = registerBoolean(true, "craftable_enchantment_echo");
