...
public class ModItemTagProvider extends FabricTagsProvider.ItemTagsProvider {
    ...
    protected void addTags(Provider registries) {
        valueLookupBuilder(ModItemTags.BOWS)
                .add(Items.BOW)
                .setReplace(false);

        valueLookupBuilder(ModItemTags.CROSSBOWS)
                .add(Items.CROSSBOW)
                .setReplace(false);
        ...
        valueLookupBuilder(ModItemTags.ELYTRAS)
                .add(Items.ELYTRA)
                .setReplace(false);

        valueLookupBuilder(ModItemTags.SHIELDS)
                .add(Items.SHIELD)
                .setReplace(false);

        valueLookupBuilder(ModItemTags.TRIDENTS)
                .add(Items.TRIDENT)
                .setReplace(false);

        valueLookupBuilder(ModItemTags.MACES)
                .add(Items.MACE)
                .setReplace(false);

        valueLookupBuilder(ModItemTags.IGNITERS)
                .add(Items.FLINT_AND_STEEL)
                .setReplace(false);

        valueLookupBuilder(ModItemTags.SHEARS)
                .add(Items.SHEARS)
                .setReplace(false);

        valueLookupBuilder(ModItemTags.BRUSHES)
                .add(Items.BRUSH)
                .setReplace(false);

        valueLookupBuilder(ModItemTags.SKULLS)
